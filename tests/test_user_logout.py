...
from locators.desk import TestLogoutUserLocators
...
class TestLogoutUser:
    ...
    def test_check_button_enter_and_registration_after_exit(self, driver, unique_email_correct):
        ...
        driver.find_element(*TestLogoutUserLocators.REPEAT_PASSWORD_FIELD).send_keys("qwerty")
        driver.find_element(*TestLogoutUserLocators.CREATE_ACCOUNT_BUTTON).click()
        WebDriverWait(driver, 10).until(expected_conditions.visibility_of_element_located(TestLogoutUserLocators.EXIT_BUTTON))
